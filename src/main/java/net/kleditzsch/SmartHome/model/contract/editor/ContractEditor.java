package net.kleditzsch.SmartHome.model.contract.editor;
...
import net.kleditzsch.SmartHome.model.contract.contract.Contract;
import net.kleditzsch.SmartHome.model.contract.contract.ContractGroup;
