...
import net.kleditzsch.SmartHome.model.automation.device.actor.Interface.MqttElement;
...
public class AutomationActorFormMqttSingleServlet extends HttpServlet {

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

        //Template Engine initalisieren
        JtwigTemplate template = JtwigFactory.fromClasspath("/webserver/template/automation/admin/actor/actorformmqttsingle.html");
            ...
            if(req.getParameter("id") != null) {
                ...
                try {
                    ...
                    if(actorOptional.isPresent() && actorOptional.get() instanceof MqttSingle) {
                        ...
                        mqttDevice = (MqttSingle) actorOptional.get();
                    } else {
                ...
                if(checkMqttName(mqttName, id, actorEditor)) {
                    ...
                    if(addElement) {
                        ...
                        if (actorOptional.isPresent() && actorOptional.get() instanceof MqttSingle) {
                            ...
                            MqttSingle mqtt = (MqttSingle) actorOptional.get();
                            mqtt.setName(name);
                            mqtt.setDescription(description);
                            mqtt.setDisabled(disabled);
                            mqtt.setMqttName(mqttName);
