...
public class AutomationDeviceFormMqttSingleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        JtwigTemplate template = JtwigFactory.fromClasspath("/webserver/template/automation/admin/device/deviceformmqttsingle.html");
            ...
            if(req.getParameter("id") != null) {
                ...
                try {
                    ...
                    if(switchableOptional.isPresent() && switchableOptional.get() instanceof MqttSingle) {
                        ...
                        mqttDevice = (MqttSingle) switchableOptional.get();
                    } else {
            ...
            if (form.isSuccessful()) {
                ...
                if(checkMqttName(mqttName, swe)) {
                    ...
                    if(addElement) {
                        ...
                        MqttSingle mqtt = new MqttSingle();
                        ...
                        if (switchableOptional1.isPresent() && switchableOptional1.get() instanceof MqttSingle) {

                            MqttSingle mqtt = (MqttSingle) switchableOptional1.get();
                            mqtt.setName(name);
                            mqtt.setDescription(description);
                            mqtt.setDisabled(disabled);
                            mqtt.setMqttName(mqttName);
