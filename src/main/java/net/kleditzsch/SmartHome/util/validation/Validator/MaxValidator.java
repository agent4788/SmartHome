...
public class MaxValidator extends AbstractValidator {
    ...
    public boolean validate(Object object, Field field, Optional<ResourceBundle> resourceBundle) throws IllegalAccessException {
        ...
        if(field.isAnnotationPresent(ValidateMax.class)) {
            ...
            if(type.isAssignableFrom(int.class)
                ...
                ValidateMax annotation = field.getAnnotation(ValidateMax.class);
                ...
                if(value > max) {
                    ...
                    message = String.format(message, NumberFormat.getInstance().format(max));
