    ...
    public void run() {
        ...
        switchableEditor.getData().stream()
                ...
                .forEach(e -> {
                    ...
                    executorService.putCommand(new SwitchCommand(e, Command.SWITCH_COMMAND.UPDATE));
                    if(e.getSocketType() == TPlinkSocket.SOCKET_TYPE.HS110) {

                        executorService.putCommand(new SwitchCommand(e, Command.SWITCH_COMMAND.UPDATE_SENSOR));
                    }
                });
