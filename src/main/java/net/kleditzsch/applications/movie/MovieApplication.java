package net.kleditzsch.applications.movie;
...
import net.kleditzsch.applications.movie.model.movie.meta.Genre;
import net.kleditzsch.applications.movie.view.admin.MovieAdminIndexServlet;
import net.kleditzsch.applications.movie.view.admin.dbimport.MovieImportServlet;
import net.kleditzsch.applications.movie.view.admin.dbimport.zip.*;
import net.kleditzsch.applications.movie.view.admin.disc.MovieDiscDeleteServlet;
import net.kleditzsch.applications.movie.view.admin.disc.MovieDiscFormServlet;
import net.kleditzsch.applications.movie.view.admin.disc.MovieDiscListServlet;
import net.kleditzsch.applications.movie.view.admin.disc.MovieDiscOrderServlet;
import net.kleditzsch.applications.movie.view.admin.fsk.MovieFskDeleteServlet;
import net.kleditzsch.applications.movie.view.admin.fsk.MovieFskFormServlet;
import net.kleditzsch.applications.movie.view.admin.fsk.MovieFskListServlet;
import net.kleditzsch.applications.movie.view.admin.fsk.MovieFskOrderServlet;
import net.kleditzsch.applications.movie.view.admin.genre.MovieGenreDeleteServlet;
import net.kleditzsch.applications.movie.view.admin.genre.MovieGenreFormServlet;
import net.kleditzsch.applications.movie.view.admin.genre.MovieGenreListServlet;
import net.kleditzsch.applications.movie.view.admin.person.MoviePersonDeleteServlet;
import net.kleditzsch.applications.movie.view.admin.person.MoviePersonFormServlet;
import net.kleditzsch.applications.movie.view.admin.person.MoviePersonListServlet;
import net.kleditzsch.applications.movie.view.admin.settings.MovieSettingsServlet;
import net.kleditzsch.applications.movie.view.admin.sortin.MovieSortInBluRayServlet;
import net.kleditzsch.applications.movie.view.admin.sortin.MovieSortInDvdServlet;
import net.kleditzsch.applications.movie.view.admin.sortin.MovieSortInIndexServlet;
import net.kleditzsch.applications.movie.view.admin.statistic.MovieStatisticServlet;
import net.kleditzsch.applications.movie.view.user.*;
import net.kleditzsch.applications.movie.view.user.movie.*;
import net.kleditzsch.applications.movie.view.user.moviebox.*;
import net.kleditzsch.applications.movie.view.user.movieseries.*;
