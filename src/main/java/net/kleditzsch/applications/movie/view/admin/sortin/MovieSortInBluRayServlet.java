package net.kleditzsch.applications.movie.view.admin.sortin;
...
public class MovieSortInBluRayServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        List<Disc> discs = discEditor.getData().stream().filter(disc -> disc.getName().toLowerCase().contains("blu-ray")).collect(Collectors.toList());
