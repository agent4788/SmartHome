package net.kleditzsch.applications.automation.controller.switchtimerservice;
...
import net.kleditzsch.applications.automation.model.global.MoveCommand;
            ...
            ste.getData().stream()
                    ...
                    .forEach(st -> {
                        ...
                        st.getCommands().stream()
                                .filter(e -> e instanceof net.kleditzsch.applications.automation.model.global.SwitchCommand)
                                .map(e -> (net.kleditzsch.applications.automation.model.global.SwitchCommand) e)
