package net.kleditzsch.applications.automation.controller.avmservice;
...
import net.kleditzsch.applications.automation.api.avm.Device.Components.PowerMeter;
import net.kleditzsch.applications.automation.api.avm.Device.Components.Switch;
import net.kleditzsch.applications.automation.api.avm.Device.Components.TemperatureSensor;
import net.kleditzsch.applications.automation.api.avm.Device.SmarthomeDevice;
import net.kleditzsch.applications.automation.api.avm.Exception.AuthException;
import net.kleditzsch.applications.automation.model.device.actor.Interface.Switchable;
import net.kleditzsch.applications.automation.model.device.actor.switchable.AvmSocket;
