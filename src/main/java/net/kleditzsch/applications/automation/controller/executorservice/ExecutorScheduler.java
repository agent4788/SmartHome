...
import net.kleditzsch.applications.automation.controller.executorservice.command.StopCommand;
import net.kleditzsch.applications.automation.controller.executorservice.command.SwitchCommand;
import net.kleditzsch.applications.automation.controller.executorservice.handler.*;
import net.kleditzsch.applications.automation.model.device.actor.shutter.MqttShutter;
import net.kleditzsch.applications.automation.model.device.actor.switchable.*;
