package net.kleditzsch.applications.automation.api.avm.Device;

import net.kleditzsch.applications.automation.api.avm.Device.Components.*;
import net.kleditzsch.applications.automation.api.avm.FritzBoxHandler;
