package net.kleditzsch.applications.shoppinglist.model.editor;
...
public class ShoppingItemSuggestionEditor {
    ...
    public static ShoppingItemSuggestionEditor create() {
        ...
        MongoCollection suggestionCollection = SmartHome.getInstance().getDatabaseCollection(COLLECTION);
