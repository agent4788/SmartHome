package net.kleditzsch.applications.recipe;
...
import net.kleditzsch.applications.recipe.view.admin.ingredient.RecipeIngredientFormServlet;
import net.kleditzsch.applications.recipe.view.admin.ingredient.RecipeIngredientListServlet;
import net.kleditzsch.applications.recipe.view.admin.settings.RecipeSettingsServlet;
import net.kleditzsch.applications.recipe.view.admin.tag.RecipeTagDeleteServlet;
import net.kleditzsch.applications.recipe.view.admin.tag.RecipeTagFormServlet;
import net.kleditzsch.applications.recipe.view.admin.tag.RecipeTagListServlet;
import net.kleditzsch.applications.recipe.view.user.RecipeBookmarkRecipeListServlet;
import net.kleditzsch.applications.recipe.view.user.RecipeImageServlet;
import net.kleditzsch.applications.recipe.view.user.RecipeIndexServlet;
import net.kleditzsch.applications.recipe.view.user.RecipeNewRecipeListServlet;
import net.kleditzsch.applications.recipe.view.user.foodlist.RecipeAddShoppingListServlet;
import net.kleditzsch.applications.recipe.view.user.foodlist.RecipeFoodListServlet;
import net.kleditzsch.applications.recipe.view.user.foodlist.RecipeUpdateFoodListServlet;
import net.kleditzsch.applications.recipe.view.user.recipe.*;
