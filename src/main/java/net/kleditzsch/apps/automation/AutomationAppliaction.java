package net.kleditzsch.apps.automation;

import net.kleditzsch.SmartHome.SmartHome;
import net.kleditzsch.SmartHome.app.Application;
import net.kleditzsch.apps.automation.controller.avmservice.AvmDataUpdateService;
...
import net.kleditzsch.apps.automation.controller.sensorservice.LiveBitUpdateService;
import net.kleditzsch.apps.automation.controller.sensorservice.UserAtHomeUpdateService;
...
import net.kleditzsch.apps.automation.view.admin.settings.AutomationSettingsServlet;
import net.kleditzsch.apps.automation.view.admin.timer.AutomationTimerDeleteServlet;
import net.kleditzsch.apps.automation.view.admin.timer.AutomationTimerFormServlet;
import net.kleditzsch.apps.automation.view.admin.timer.AutomationTimerListServlet;
import net.kleditzsch.apps.automation.view.user.*;
