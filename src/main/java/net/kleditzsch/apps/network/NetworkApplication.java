package net.kleditzsch.apps.network;

import net.kleditzsch.SmartHome.app.Application;
import net.kleditzsch.apps.network.view.user.NetworkIndexServlet;
import net.kleditzsch.apps.network.view.user.nasstate.NetworkNasStateServlet;
import net.kleditzsch.apps.network.view.user.overview.NetworkDeviceDeleteServlet;
import net.kleditzsch.apps.network.view.user.overview.NetworkDeviceFormServlet;
import net.kleditzsch.apps.network.view.user.overview.NetworkGroupDeleteServlet;
import net.kleditzsch.apps.network.view.user.overview.NetworkGroupFormServlet;
import net.kleditzsch.apps.network.view.user.printerstate.NetworkPrinterStateServlet;
